...
public class BoardDataDrawer : Editor
{
   ...
   private void OnEnable(){
    InitializeReaordableList(ref _dataList,"SearchWords","SearchingWords");
   }
    ...
    private void InitializeReaordableList(ref ReorderableList list, string propertyName, string listLabel)
    {
    ...
    private void FillUpRandomLettersButton(){
